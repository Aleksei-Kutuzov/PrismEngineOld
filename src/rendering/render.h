...
#include "SDL.h"
#include "SDL_image.h"
#include "/../Objects3D/AbstractObject3D.h"
#include <string>
#include <unistd.h>
...
//	RemInRender(AbstractObject3D object3d);
	SDL_Texture * ReturnFrameTexture(int DWidth, int DHeight, RenderMode rm);
	void RenderFrameSurfase(int DWidth, int DHeight, RenderMode rm);
